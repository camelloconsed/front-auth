export const SERVICE_ERROR: string = 'errors/SERVICE_ERROR'
...
export const UNKNOWN_ERROR: string = 'errors/UNKNOWN_ERROR'
export const CLEAR_ERROR : string = 'error/CLEAR_ERROR'
